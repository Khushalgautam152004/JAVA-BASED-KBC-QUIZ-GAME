...
public class Rules extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Your time will start as soon as you will enter play game panel");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel3.setText("You will get 30 seconds to answer the question, if not given");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel4.setText("answer within 30 seconds then you will lose the game.");

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jButton1.setForeground(new java.awt.Color(0, 153, 0));
        jButton1.setText("Start My Game");
        ...
        setSize(new java.awt.Dimension(1758, 941));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PlayGame pg=new PlayGame(email1);
        pg.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rules(null).setVisible(true);
            }
        });
    }
